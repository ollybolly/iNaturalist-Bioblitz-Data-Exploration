# ==============================================================================
# Walpole Wilderness Bioblitz 2025 - Data Dive Analysis
#
...
zoom_utm       <- 32750   # WGS84 / UTM zone 50S (Walpole, WA)
...
css_content <- paste0('
/* Custom CSS for Walpole Wilderness Bioblitz Presentation */
